 ...
 * Original file: E:\\Tourpal\\mobilesafe\\src\\android\\content\\pm\\IPackageDataObserver.aidl
 */
...
case TRANSACTION_onRemoveComplete:
{
...
this.onRemoveComplete(_arg0, _arg1);
return true;
}
}
...
@Override public void onRemoveComplete(java.lang.String packageName, boolean succeeded) throws android.os.RemoteException
{
...
mRemote.transact(Stub.TRANSACTION_onRemoveComplete, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_onRemoveComplete = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
}
public void onRemoveComplete(java.lang.String packageName, boolean succeeded) throws android.os.RemoteException;
}
